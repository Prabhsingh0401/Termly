        ...
        <div className="m-auto w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-background py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-muted/50"
            >
              <GoogleIcon />

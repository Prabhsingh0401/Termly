...
export default function SearchPage() {
  ...
  return (
    <DashboardLayout>
      <div className="pb-28 md:pb-6 max-w-5xl mx-auto px-4">
        {/* Search bar */}
        <div className="mb-6">
          ...
          <div className="flex-1">
            {showPrompt ? (
              ...
              <div className="space-y-3">
                ...
                {filtered.map((c) => {
                  const isBill = c.document_type === 'bill' || c.documentType === 'bill';
                  return (
                    <Card key={c.id} hoverable onClick={() => router.push(isBill ? `/bills/${c.id}` : `/contracts/${c.id}`)}>
